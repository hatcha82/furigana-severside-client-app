    ...
    <v-card 
      ...
      >
        ...
        <div style="position: relative; padding-bottom: 56.25%;">
          <iframe 
            :src="'https://www.youtube.com/embed/'+ song.youtubeId +'?autoplay=1&playsinline=1'" 
      ...
      <div 
        ...
        <div 
          ...
          <h2 
            class="noYoutube grey--text"
          >등록된 YouTubu가 없습니다.</h2>
        </div>
      </div>
    </v-card>
  </div>
